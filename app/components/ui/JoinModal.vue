          ...
          >
            ...
            <div class="px-6 pb-6 space-y-4">
              <template v-for="option in options" :key="option.id">
                ...
                <div
                  v-else
                  class="relative block p-5 rounded-xl border-2 border-gray-200 dark:border-repae-gray-700 opacity-50 cursor-not-allowed"
                >
                  <div class="flex items-start gap-4">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 bg-gray-200 dark:bg-repae-gray-700">
                      <font-awesome-icon
                        :icon="option.icon"
                        class="text-xl text-repae-gray-400 dark:text-repae-gray-500"
                      />
                    </div>
                    <div class="flex-1">
                      <div class="flex items-center gap-2 mb-1">
                        <h3 class="font-bold font-brand text-repae-gray-400 dark:text-repae-gray-500">
                          {{ option.title }}
                        </h3>
                        <span class="px-2 py-0.5 text-xs font-semibold font-brand rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400">
                          Bientôt
                        </span>
                      </div>
                    ...
                    <font-awesome-icon
                      ...
                      class="text-lg mt-1 text-repae-gray-300 dark:text-repae-gray-600"
                    />
                  </div>
                </div>
              </template>
