<script setup>
import { stats as statsData, testimonialsRow1 as testimonialsRow1Data, testimonialsRow2 as testimonialsRow2Data } from '@/data/testimonials'

// Stats data (imported from external file)
const stats = ref(statsData)
const testimonialsRow1 = ref(testimonialsRow1Data)
const testimonialsRow2 = ref(testimonialsRow2Data)
